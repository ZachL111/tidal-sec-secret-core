"""Regression checks for the tidal-sec-secret-core casebook."""
...
from casebook.harness import assert_expected, tidal_sec_secret_core_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(tidal_sec_secret_core_summary(), assert_expected())
